...
<?php if (isset($_GET['message'])): ?>
    <div class="alert alert-success">
        ...
        echo isset($messages[$_GET['message']]) 
        ...
        <?php if ($employees->rowCount() > 0): ?>
            <?php while ($row = $employees->fetch(PDO::FETCH_ASSOC)): ?>
                <tr>
                    ...
                    <td><span style="padding: 0.25rem 0.5rem; background: #e9ecef; border-radius: 4px;"><?php echo htmlspecialchars($row['department']); ?></span></td>
